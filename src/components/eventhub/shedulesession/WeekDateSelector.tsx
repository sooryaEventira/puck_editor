...
const WeekDateSelector: React.FC<WeekDateSelectorProps> = ({
  ...
  return (
    <div className={`flex items-center gap-2 sm:gap-4 ${className}`}>
      ...
      <div className="flex flex-1 gap-2 overflow-x-auto pb-2 sm:gap-3 sm:overflow-visible sm:pb-0">
        {weekDates.map((date, index) => {
          ...
          return (
            <button
              ...
              className={`inline-flex shrink-0 flex-col items-center justify-center rounded-[10px] px-4 py-2 text-xs transition-all duration-200  sm:px-[20px] sm:py-2.5 sm:text-sm md:min-w-[140px] md:px-[30px] md:py-3 ${
                isSelected
