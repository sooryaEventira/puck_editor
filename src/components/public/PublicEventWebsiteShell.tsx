...
type PublicSection = 'webpage' | 'speakers' | 'attendees' | 'schedule' | 'sessions'

interface PublicEventWebsiteShellProps {
  eventUuid: string
}

const getSectionFromPath = (eventUuid: string, pathname: string): { section: PublicSection; webpageUuid?: string } => {
